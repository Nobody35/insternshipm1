...
\begin{tikzpicture}[node distance=2.5cm,>=stealth',bend angle=45,auto]
    \cmdtikz
\node [draw = none] (bfirst) {};
\mon {bmon}{right of = bfirst}
\rt {bfirst};
\ou {bou}{right of = bmon}{}
\rt {bmon};

\et {bet2}{right of =bou }{}
\rt {bou};

\tl {bl}{above right of =bet2 }{\lambda_2}
\rt {bet2};
...
\ntl {bntl}{left of =bet }{\lambda_2}
\rt {bet};

\expl {bcon}{right of = bet}{consistency}
\rt{bet2}
\rt {bet};
...
\node [draw = none, right of = bet2] (bzt2) {}
\rt{bet2};
