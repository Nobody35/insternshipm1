...
\begin{tikzpicture}[node distance=2.5cm,>=stealth',bend angle=45,auto]
    \cmdtikz
\node [draw = none] (cfirst) {};


\ou {cou}{right of = cfirst}{}
\rt {cfirst};

\et {cet}{below right of = cou}{}
\rt {cou};


\peq{cpeq2}{ right of = cou}{2}
\rt{cou};


\eq{ceq2}{ below right of = cet}{2}
\rt{cet};

\peq{cpeq1}{ below of = cet}{1}
\rt{cet};


\peq{cpeq0}{ below left of = cet}{0}
\rt{cet};

\et {cet1}{above right of = cou}{}
\rt {cou};



\eq{ceq}{ above right of = cet1}{0}
\rt{cet1};

\eq{ceq1}{ above  of = cet1}{1}
\rt{cet1};


\eq{ceq2}{ above left of = cet1}{2}
\rt{cet1};
